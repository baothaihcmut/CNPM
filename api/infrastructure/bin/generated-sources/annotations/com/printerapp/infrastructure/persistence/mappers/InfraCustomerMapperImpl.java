...
public class InfraCustomerMapperImpl implements InfraCustomerMapper {
    ...
    @Override
    public Customer toPersistence(com.printerapp.domain.aggregates.customer.Customer customer) {
        if ( customer == null ) {
            return null;
        }
    ...
    @Override
    public com.printerapp.domain.aggregates.customer.Customer toDomain(Customer model) {
        if ( model == null ) {
            return null;
        }
        ...
        com.printerapp.domain.aggregates.customer.Customer customer = new com.printerapp.domain.aggregates.customer.Customer( userId, customerId );
    ...
    private UUID customerIdValue(com.printerapp.domain.aggregates.customer.Customer customer) {
        if ( customer == null ) {
            return null;
        }
    ...
    private String customerCustomerIdValue(com.printerapp.domain.aggregates.customer.Customer customer) {
        if ( customer == null ) {
            return null;
        }
    ...
    private CustomerType customerCustomerIdCustomerType(com.printerapp.domain.aggregates.customer.Customer customer) {
        if ( customer == null ) {
            return null;
        }
        CustomerId customerId = customer.getCustomerId();
