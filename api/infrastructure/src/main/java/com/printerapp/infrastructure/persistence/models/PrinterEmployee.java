...
public class PrinterEmployee extends BaseEntity {
    ...
    public PrinterEmployee(UUID id, UUID employeeId, UUID printerId, String name, String location, String code,
            PrinterStatus status, Boolean isManger, Integer numOfTransactionProcess,
