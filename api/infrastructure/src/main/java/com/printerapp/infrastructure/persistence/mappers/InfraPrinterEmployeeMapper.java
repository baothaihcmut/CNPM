...
public interface InfraPrinterEmployeeMapper {
    ...
    @Mappings(value = {
            ...
            @Mapping(target = "printerName", source = "printer.name"),
            @Mapping(target = "printerCode", source = "printer.code"),
            @Mapping(target = "printerLocation", source = "printer.location"),
            @Mapping(target = "printerStatus", source = "printer.status")
    })
