...
public interface InfraTransactionMapper {
        ...
        @Mappings(value = {
                        ...
                        @Mapping(source = "customer.user.firstName", target = "customerName.firstName"),
                        @Mapping(source = "customer.user.lastName", target = "customerName.lastName"),
                        @Mapping(source = "employee.id", target = "employeeId.value"),
                        @Mapping(source = "employee.user.firstName", target = "employeeName.firstName"),
                        @Mapping(source = "employee.user.lastName", target = "employeeName.lastName"),
