...
public class PrinterService {
        ...
        public PaginatedResult<PrinterTransactionResult> findAllTransactionOfPrinter(
                ...
                // return
                return PaginatedResult.<PrinterTransactionResult>of(
                                transactions.getData().stream()
                                                .map((transaction) -> this.applicationPrinterMapper
                                                                .toPrinterTransactionResult(transaction))
                                                .toList(),
        ...
        public PaginatedResult<PrinterResult> searchPrinter(SearchPrinterQuery search) {
                String[] fields = { "name", "location", "code" };
                List<FilterParam<?>> filters = new ArrayList<>();
                ...
                PaginatedResult<Printer> res = this.printerRepository.search(filters,
                                List.of(statusCriteria),
