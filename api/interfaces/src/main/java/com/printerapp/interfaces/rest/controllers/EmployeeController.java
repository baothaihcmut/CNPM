...
public class EmployeeController {
    ...
    public ResponseEntity<AppResponse> getAllPrinterOfEmployee() {
        List<EmployeePrinterResult> res = this.employeeService.findAllPrinterOfEmployee();
    ...
    public ResponseEntity<AppResponse> getAllTransactionOfEmployeeByPPrinter(
        ...
        PaginatedResult<EmployeeTransactionResult> res = this.employeeService.findAllTransactionOfEmployee(
    ...
    public ResponseEntity<AppResponse> findAllTransactionOfEmployee(@PathVariable("id") UUID userId,
            ...
            @RequestParam(value = "page", defaultValue = "1") Integer page,
            @RequestParam(value = "size", defaultValue = "10") Integer size) {
        PaginatedResult<EmployeeTransactionResult> res = this.employeeService
